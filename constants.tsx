...
import { FamilyMember, Role, PlanType, PlanStatus, Priority, Visibility, FamilyPlan, Chat, StatusUpdate } from './types';

export const MOCK_MEMBERS: FamilyMember[] = [
  { id: '1', name: 'John (Dad)', role: Role.PARENT, avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=John' },
  { id: '2', name: 'Sarah (Mom)', role: Role.PARENT, avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Sarah' },
  { id: '3', name: 'Leo', role: Role.CHILD, avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Leo' },
  { id: '4', name: 'Maya', role: Role.CHILD, avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Maya' },
  { id: 'ai', name: 'Family AI', role: Role.PARENT, avatar: 'https://api.dicebear.com/7.x/bottts/svg?seed=FamilyAI' },
];
...
export const INITIAL_CHATS: Chat[] = [
  {
    ...
    lastMessage: {
      ...
      senderId: '2',
      senderName: 'Sarah',
      text: "Don't forget the pizza night!",
      timestamp: new Date(),
      type: 'text'
    }
  },
  {
    ...
    type: 'ai',
    participants: ['ai'],
    avatar: 'https://api.dicebear.com/7.x/bottts/svg?seed=FamilyAI',
    unreadCount: 0,
    lastMessage: {
      id: 'm2',
      senderId: 'ai',
      senderName: 'Family AI',
...
export const INITIAL_PLANS: FamilyPlan[] = [
  {
    ...
    type: PlanType.EVENT,
    description: 'Weekly tradition of making pizzas together.',
...
export const INITIAL_STATUSES: StatusUpdate[] = [
  {
    id: 's1',
    senderId: '2',
    senderName: 'Sarah (Mom)',
    senderAvatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Sarah',
    type: 'text',
    content: 'Just finished baking brownies! Come to the kitchen! 🍪',
    backgroundColor: '#6366f1',
    timestamp: new Date(Date.now() - 1200000),
    viewers: ['1'],
    reactions: [{ emoji: '😋', userId: '3' }]
  },
  {
    id: 's2',
    senderId: 'ai',
    senderName: 'Family AI',
    senderAvatar: 'https://api.dicebear.com/7.x/bottts/svg?seed=FamilyAI',
    type: 'text',
    content: 'Family Tip: Remember to drink enough water today! 💧',
  ...
  },
  {
    ...
    senderId: '3',
    senderName: 'Leo',
    senderAvatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Leo',
    type: 'image',
    content: 'https://images.unsplash.com/photo-1544620347-c4fd4a3d5957?w=800&q=80',
    timestamp: new Date(Date.now() - 7200000),
    viewers: ['2'],
    reactions: [{ emoji: '❤️', userId: '2' }]
  }
];
...
export const ICONS = {
  ...
  AI: <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9.663 17h4.674a1 1 0 00.922-.606l7-15A1 1 0 0021.333 0h-18.666A1 1 0 001.744 1.394l7 15a1 1 0 00.919.606zM2 1h20M7 23h10M9 21h6" /></svg>,
  ...
  Pin: <svg className="w-4 h-4 rotate-45" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M5 4a2 2 0 012-2h6a2 2 0 012 2v14l-5-2.5L5 18V4z" clipRule="evenodd" /></svg>,
  ...
  Forward: <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M14 5l7 7m0 0l-7 7m7-7H3" /></svg>,
  ...
  QRCode: <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 4v1m0 11v1m4-6h1m-11 0h1m2-2h4m-4 4h4m1-4v4M7 9v4m10-4v4M5 5h3v3H5V5zm0 11h3v3H5v-3zm11-11h3v3h-3V5zm0 11h3v3h-3v-3z" /></svg>,
  ...
  Play: <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM9.555 7.168A1 1 0 008 8v4a1 1 0 001.555.832l3-2a1 1 0 000-1.664l-3-2z" clipRule="evenodd" /></svg>,
  Pause: <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zM7 8a1 1 0 012 0v4a1 1 0 11-2 0V8zm4 0a1 1 0 012 0v4a1 1 0 11-2 0V8z" clipRule="evenodd" /></svg>,
  ...
  Status: <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" /></svg>,
};
